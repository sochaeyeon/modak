...
public interface AdminMapper {
    ...
    /* ─── 고객 문의 관리 ─── */
    List<HashMap<String, Object>> selectAdminInquiryList(HashMap<String, Object> map);
    int selectAdminInquiryCount(HashMap<String, Object> map);
    void insertInquiryReply(HashMap<String, Object> map);
    ...
    /* ─── 리뷰 및 이벤트 관리 ─── */
    List<HashMap<String, Object>> selectAdminReviewList(HashMap<String, Object> map);
    int selectAdminReviewCount(HashMap<String, Object> map);
