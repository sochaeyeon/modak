...
public class MembershipController {
	...
	// 등급 목록 DB 조회
	@RequestMapping("/membership/grade/list.dox")
	@ResponseBody
	public String getGradeList() {
		HashMap<String, Object> resultMap = membershipService.getGradeList();
		return new Gson().toJson(resultMap);
	}

	// FAQ 목록 DB 조회
	@RequestMapping("/membership/faq/list.dox")
	@ResponseBody
	public String getFaqList() {
		HashMap<String, Object> resultMap = membershipService.getFaqList();
		return new Gson().toJson(resultMap);
	}
}