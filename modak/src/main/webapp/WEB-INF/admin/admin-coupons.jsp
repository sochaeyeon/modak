                    ...
                    <div id="app" class="admin-main">
                        <div class="coupon-page-container">
                            ...
                            <div class="ev-filter-bar"
                                style="border-bottom: 1px solid var(--border); margin-bottom: 20px; gap: 20px;">
                                <span :class="['tab-item', {active: currentTab === 'master'}]"
                                    @click="currentTab = 'master'; fnLoad();" style="cursor:pointer; padding: 10px;">쿠폰
                                    마스터 관리</span>
                                    ...
                                    <table class="c-table">
                                        ...
                                        <tbody>
                                            <tr v-for="item in couponList" :key="item.COUPON_ID">
                                                ...
                                                <td>
                                                    <span
                                                        :class="item.IS_ACTIVE === 'Y' ? 'status-dot active-dot' : 'status-dot inactive-dot'"></span>
                                                    <span
                                                        :style="{color: item.IS_ACTIVE === 'Y' ? '#58d68d' : '#ec7063'}">
                                                        {{ item.IS_ACTIVE === 'Y' ? '사용가능' : '정지됨' }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <div style="display:flex; gap:5px; justify-content:center;">
                                                        <button class="btn-sm" @click="fnGiveAll(item.COUPON_ID)"
                                                            style="background:var(--orange); color:#fff; border:none; padding:4px 8px; border-radius:4px; cursor:pointer;">전체발급</button>
                                                        <button class="btn-sm" @click="fnOpenGiveUser(item)"
                                                            style="background:var(--blue); color:#fff; border:none; padding:4px 8px; border-radius:4px; cursor:pointer;">개별지급</button>
                                                    </div>
                                                </td>
                                                <td>
                                                    <div style="display:flex; gap:8px; justify-content:center;">
                                                        ...
                                                        <button class="p-btn-secondary" style="color:#ec7063;"
                                                            @click="fnDelete(item.COUPON_ID)">삭제</button>
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
                                    ...
                                    <table class="c-table">
                                        ...
                                        <tbody>
                                            <tr v-for="uc in userCouponList" :key="uc.USER_COUPON_ID">
                                                ...
                                                <td>
                                                    <span class="badge"
                                                        :class="uc.USED_YN === 'Y' ? 'badge-done' : 'badge-active'">
                                                        {{ uc.USED_YN === 'Y' ? '사용완료' : '미사용' }}
                                                    </span>
                                                </td>
                                                <td>
                                                    <button class="btn-sm" @click="fnToggleUsed(uc)"
                                                ...
                                                <td>
                                                    <button class="p-btn-secondary" style="color:#ec7063;"
                                                        @click="fnRemoveUserCoupon(uc.USER_COUPON_ID)">삭제</button>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
                        ...
                        <div class="ev-modal-overlay" :class="{open: userModalOpen}" @click.self="userModalOpen=false">
                            <div class="ev-modal">
                                ...
                                <div class="modal-body">
                                    <div
                                        style="background:var(--bg3); padding:10px; border-radius:8px; margin-bottom:15px; font-size:14px;">
                                    ...
                                    <p style="font-size:12px; color:var(--text3); margin-top:5px;">* 해당 유저의 보유 쿠폰함으로 즉시
                                        발송됩니다.</p>
                                </div>
                                <div class="modal-footer">
                    ...
                    <script>
                        ...
                        createApp({
                            data() {
                                return {
                                    ...
                                    form: {
                                        ...
                                        couponType: 'AMOUNT', // ★ type → couponType
                                        discountAmt: 0,        // ★ value → discountAmt
                                        discountRate: 0,        // ★ 추가
                                        minOrderAmt: 0,        // ★ minPrice → minOrderAmt
                                        issueTarget: 'ALL',    // ★ 추가
                                        startDate: '',       // ★ 추가
                            ...
                            methods: {
                                ...
                                fnSave() {
                                    if (!this.form.couponName) return alert("이름 입력!");  // ★ name → couponName
