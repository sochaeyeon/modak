                    ...
                    <div class="page-wrap">
                        ...
                        <div class="form-section">
                                    ...
                                    <div style="margin-top:12px;">
                                        ...
                                        <div class="poll-option-row" v-for="(opt, i) in poll.options" :key="i">
                                            ...
                                            <button class="btn-remove-option" @click="fnRemoveOption(i)"
                                                v-if="poll.options.length > 2" type="button" aria-label="선택지 삭제">
                                                <i class="ri-close-line"></i>
                                            </button>
                                        </div>

                                        <button class="btn-add-option" @click="poll.options.push('')"
                                            v-if="poll.options.length < 6" type="button">
                            ...
                            <div class="action-row">
                                <button class="btn-cancel" @click="fnCancel" type="button">
                                    취소
                                </button>
                            ...
                            methods: {
                                ...
                                fnLoadBoard() {
                                    ...
                                    $.ajax({
                                        ...
                                        dataType: 'json',
                                        success: (res) => {
                                            const board = res.board || res.info || res.map || res;

                                            if (!board || !board.boardId) {
                                                this.showToast(res.message || '게시글 정보를 불러오지 못했습니다.');
                                                return;
                                            }

                                            this.form.title = board.title || '';
                                            this.form.category = board.category || 'FREE';

                                            if (this.quill) {
                                                this.quill.root.innerHTML = board.content || '';
                                            }
                                            ...
                                            if (board.productId) {
                                                this.selectedProduct = {
                                                    ...
                                                    price: board.productPrice || 0,
                                                    imgUrl: board.productImg || '/img/product/default.jpg'
                                                };

                                                this.productKeyword = board.productName || '';
                                            }
                                ...
                                fnSetLoadedTags(res, board) {
                                    let loadedTags = res.tagList || res.tags || board.tags || [];
                                ...
                                fnSetLoadedPoll(res, board) {
                                    const pollData = res.poll || board.poll;
