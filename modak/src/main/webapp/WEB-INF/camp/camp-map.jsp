        ...
        <div id="app" v-cloak>
            ...
            <div v-if="isReviewModalOpen" class="modal-overlay review-modal-overlay"
                ...
                <div class="modal-content review-modal-content">
                    ...
                    <div class="review-list-scroll">
                        <div v-for="rev in reviewList" :key="rev.campReviewId" class="review-item review-item-full"
            ...
            <div v-if="isReviewDetailOpen" class="modal-overlay" @click.self="isReviewDetailOpen = false">
                <div class="review-detail-card">
                    <button class="modal-close-btn" style="position:static;float:right"
            ...
            var vueApp = Vue.createApp({
                data: function () {
                    return {
                        ...
                        targetCampId: "${param.campId != null ? param.campId : ''}"
                    };
                },
                ...
                methods: {
                    ...
                    fnFetch: function () {
                        ...
                        $.ajax({
                            ...
                            success: function (data) {
                                ...
                                if (self.targetCampId) {
                                    var target = self.allData.find(function (item) {
                                        return String(item.contentId) === String(self.targetCampId);
                                    });

                                    if (target) {
                                        self.openDetail(target);
                                    }
                                }
                            }
                        });
                    ...
                    /* ── 검색 / 필터 ── */
                    fnSearch: function () { this.activeTag = ''; this.fnApplyFilter(); },
                    fnTagSearch: function (tag) { this.activeTag = (this.activeTag === tag) ? '' : tag; this.searchKeyword = ''; this.fnApplyFilter(); },
                    fnFilterArea: function () { this.activeTag = ''; this.searchKeyword = ''; this.fnApplyFilter(); },

                    fnApplyFilter: function () {
                        var keyword = (this.searchKeyword || this.activeTag).trim().toLowerCase();
