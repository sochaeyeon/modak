                    ...
                    <div class="hero-summary-card">
                        ...
                        <div class="hero-summary-value">
                            <transition name="count-rise" mode="out-in">
                                <span class="result-count-number" :key="totalCount">{{ totalCount }}</span>
                            </transition>
                        ...
                        <div class="wishlist-content" :key="'inquiry-' + listAnimateKey">
                            ...
                            <div v-else class="review-list inquiry-list">
                                <div class="review-item inquiry-item"
                                    ...
                                    <div class="inquiry-title-row">
                                        ...
                                        <div class="inquiry-right-tools">
                                            ...
                                            <button type="button"
                                                ...
                                                <span>{{ expandedInquiryId === item.inquiryId ? '접기' : '펼치기' }}</span>
                                                <span class="arrow"
                                    ...
                                    <!-- 펼침 -->
                                    <div v-if="expandedInquiryId === item.inquiryId" class="inquiry-expand-area">
    ...
    <div class="inquiry-detail-section">
        ...
        <div v-if="isImageModalOpen" class="image-modal" @click="fnCloseImageModal">
            <div class="image-modal-content" @click.stop>
                ...
                <button class="image-modal-nav prev"
                        v-if="modalImageList.length > 1"
                        @click="fnPrevImage">
                    ‹
                </button>

                <img :src="modalImageList[currentImageIndex].imgUrl"
                     alt="확대 이미지"
                     class="image-modal-img">

                <button class="image-modal-nav next"
                        v-if="modalImageList.length > 1"
                        @click="fnNextImage">
                    ›
                </button>
