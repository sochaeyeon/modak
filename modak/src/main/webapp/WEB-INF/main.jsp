			...
			<style>
				...
				* {
				...
				.hero-bg {
					position: absolute;
					inset: 0;
					background: radial-gradient(ellipse 70% 60% at 50% 60%, #EDE0C4 0%, var(--cream) 70%);
					z-index: 0
				}
			...
			<div id="app">
				...
				<section class="hero">
					...
					<div class="smoke-container">
						...
						<div class="smoke"
							style="width:40px;height:40px;left:10px;animation-duration:6s;animation-delay:1.5s;"></div>
						<div class="smoke"
							style="width:25px;height:25px;left:35px;animation-duration:4.5s;animation-delay:3s;"></div>
					</div>
				...
				<section class="section">
					...
					<div class="cat-grid">
						<div class="cat-item">
							<div class="cat-icon">⛺</div><span>텐트</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">🛏️</div><span>침낭</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">🍳</div><span>취사</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">💡</div><span>조명</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">🪑</div><span>의자</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">🔒</div><span>안전</span>
						</div>
						<div class="cat-item">
							<div class="cat-icon">🎒</div><span>기타</span>
						</div>
					</div>
				</section>
				...
				<section class="section" id="weatherApp">
					...
					<div class="ws-grid">
						<div class="ws-card">
							...
							<h3>현재 날씨</h3>
							<p style="font-size:28px; font-weight:700; color:var(--orange); margin:10px 0;">{{ temp }}°C
							</p>
				...
				<div class="chatbot-fab"
					style="position: fixed; bottom: 30px; right: 30px; z-index: 1000; display: flex; align-items: center; gap: 10px; cursor: pointer;">
					<span class="fab-label"
						style="background: var(--brown); color: white; padding: 8px 16px; border-radius: 20px; font-size: 13px; box-shadow: 0 4px 10px rgba(0,0,0,0.2);">챗봇
						문의</span>
					<div class="fab-btn"
						style="width: 60px; height: 60px; background: var(--orange); border-radius: 50%; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 15px rgba(232,115,42,0.4); font-size: 24px; color: white;">
						💬</div>
				</div>
			</div>
			<script>
