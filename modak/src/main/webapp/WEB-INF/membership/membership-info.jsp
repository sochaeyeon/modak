...
<div id="app" v-cloak>
    <div class="wrap">
        ...
        <section class="cta" v-if="!isLoggedIn">
            ...
            <div class="cta-btns">
                <button class="btn-join"  @click="location.href='/user/sign.do'">무료 회원가입</button>
                <button class="btn-login" @click="location.href='/user/login.do'">로그인</button>
            </div>
        </section>
...
var app = Vue.createApp({
    data: function() {
        return {
            ...
            pointMethods: [
                { icon:'📦', title:'장비 대여',   desc:'대여 금액에 따라 포인트 적립',     rate:'최대 5%'    },
                { icon:'⭐', title:'리뷰 작성',   desc:'사진 리뷰 작성 시 포인트 지급',     rate:'+200P'      },
                { icon:'👥', title:'친구 초대',   desc:'친구 가입 완료 시 포인트 지급',     rate:'+1,000P'    },
                { icon:'🎂', title:'생일 보너스', desc:'생일 달에 쿠폰 또는 포인트 지급',   rate:'+500P'      },
                { icon:'📱', title:'앱 출석',     desc:'매일 출석 시 포인트 적립',          rate:'+10P / 일'  }
            ]
        };
    },
