...
<head>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .product-price { font-family: 'Nanum Myeongjo', serif; font-size: 15px; font-weight: 700; color: var(--brown); }
        ...
        .btn-cancel {
            ...
            color: var(--orange2); font-family: 'Noto Sans KR', sans-serif;
        ...
        .btn-return {
            ...
            color: var(--brown3); font-family: 'Noto Sans KR', sans-serif;
            font-size: 13px; font-weight: 500; cursor: pointer; transition: all .2s;
        }
        ...
        .modal-title { font-family: 'Nanum Myeongjo', serif; font-size: 20px; font-weight: 800; color: var(--brown); text-align: center; margin-bottom: 10px; }
