    ...
    <div class="guest-detail-page" v-else-if="order">
        ...
        <section class="flow-card">
            ...
            <div class="status-flow">
                <div v-for="step in statusSteps" :key="step.code"
                     class="status-step"
            ...
            <div class="left-col">
                ...
                <section class="detail-card">
                    ...
                    <div class="product-list">
                        ...
                        <article v-for="(item, index) in itemList"
                                 :key="index"
                                 class="product-item"
                        ...
                        <div class="info-row full">
                            ...
                            <strong>
                                <template v-if="order.deliveryAddr">
                                    ({{ order.zipcode }}) {{ order.deliveryAddr }} {{ order.deliveryDetailAddr }}
                                </template>
        ...
        <section class="detail-card tracking-card">
            <div class="card-head">
                ...
                <span v-if="order.trackingNo" class="tracking-no">
                    {{ order.trackingNo }}
                </span>
            </div>

            <div class="empty-box">
                아직 배송 조회 정보가 없습니다.<br>
        ...
        <div class="modal-overlay" :class="{ open: modalOpen }" @click.self="closeModal">
            <div class="modal-box">
                ...
                <div class="cancel-form">
                    ...
                    <textarea v-model="cancelReasonText"
