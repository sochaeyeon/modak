...
<head>
    ...
    <style>
        .track-btn    { background: #2196f3 !important; color: #fff !important; }
        .track-btn:hover { background: #1976d2 !important; }
        .exchange-btn { background: #9c27b0 !important; color: #fff !important; }
        .exchange-btn:hover { background: #7b1fa2 !important; }
    </style>
</head>
                    ...
                    <div v-for="item in group.items" :key="item.orderId" class="order-card-wrap">
                        <div class="order-card" :class="{ open: expandedOrderId === item.orderId }"
                            ...
                            <div class="card-left">
                                <div class="thumb">
                                    <img v-if="item.itemList && item.itemList.length > 0 && item.itemList[0].imgUrl"
                                        :src="item.itemList[0].imgUrl" :alt="item.itemList[0].productName">
                                ...
                                <div class="info">
                                    ...
                                    <div class="name-row">
                                        <strong>
                                            ...
                                            <span v-if="item.itemList && item.itemList.length > 0 && item.itemList[0].brandName"
                                        ...
                                        <span v-if="item.itemList && item.itemList.length > 1" class="extra">
                            ...
                            <div class="card-right">
                                ...
                                <div class="order-btn-group" @click.stop>
                                    <button class="detail-btn detail-main-btn" @click="fnGoOrderDetail(item.orderId)">
                                        주문상세
                                    </button>
                                    <button class="detail-btn sub-action-btn"
                                        ...
                                        {{ action === '반납 신청' && fnIsReturnRequested(item) ? '반납 신청 완료' : action }}
                                    </button>
                                </div>
                            </div>

                            <div class="order-open-indicator">
                                <i class="fa-solid" :class="expandedOrderId === item.orderId ? 'fa-chevron-up' : 'fa-chevron-down'"></i>
                            </div>
                        </div>
                        ...
                        <transition name="expand-fade">
                            <div v-if="expandedOrderId === item.orderId" class="order-expand-box">
                                ...
                                <div v-for="orderItem in item.itemList" :key="orderItem.itemId" class="expand-item-row">
                                    <div class="expand-thumb">
                                        <img v-if="orderItem.imgUrl" :src="orderItem.imgUrl" :alt="orderItem.productName">
                                    ...
                                    <div class="expand-info">
                                        ...
                                        <div v-if="orderItem.categoryName" class="order-category-pill expand-category-pill">
                                            {{ orderItem.categoryName }}
                                        </div>
                                        <div class="expand-meta">
                                            수량 {{ orderItem.count }}개 · {{ fnFormatPrice(orderItem.price) }}
                                        </div>
                                        <div class="expand-meta"
