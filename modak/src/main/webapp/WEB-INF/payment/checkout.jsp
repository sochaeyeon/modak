					...
					<div class="checkout-layout">
									...
									<div class="guest-addr-form">
										...
										<div class="guest-field-wrap">
											...
											<input class="guest-input" v-model="newAddr.receiverPhone"
												placeholder="01012345678" maxlength="11" @input="onAddrPhoneInput" />
										</div>
							...
							<section class="co-section order-section">
								...
								<div v-else class="order-cart-card">
									...
									<div class="order-brand-subtotal">
										...
										<span class="order-brand-subtotal-val" :class="{ 'red': shippingFee > 0 }">
									...
									<div class="guest-addr-form">
										...
										<div class="guest-field-wrap">
											...
											<div class="zipcode-row">
												...
												<button type="button" class="addr-search-btn" @click="fnSendAddrSmsCode"
											...
											<transition name="slide-down">
												<div v-if="addrSmsVisible" class="sms-verify-row">
													<div class="zipcode-row" style="margin-top: 8px;">
														<input class="guest-input" v-model="addrSmsCode"
															placeholder="인증번호 입력" />
														<button type="button" class="addr-search-btn confirm-btn"
															@click="fnVerifyAddrSmsCode" :disabled="addrSmsExpired">
															확인
														</button>
													</div>
													<div class="sms-timer">
										...
										<div class="guest-field-wrap">
											...
											<input class="guest-input optional" ref="detailAddressInput"
												v-model="newAddr.detailedAddress" placeholder="상세주소 (101동 202호)"
						...
						<div class="cart-aside checkout-aside">
							<div class="aside-box">
								...
								<div class="aside-row" style="margin-bottom: 12px;">
									<span>총 선택상품금액</span>
								...
								<div class="aside-rows">
									<div class="aside-row">
										<span>총 배송비</span>
										<span class="val" :class="{ 'red': shippingFee > 0 }">
											{{ shippingFee > 0 ? '+' + formatPrice(shippingFee) : '무료' }}
										</span>
									</div>
							...
							<div class="addr-list">
								<div v-for="addr in addressList" :key="addr.addressId" class="addr-select-item"
									...
									<div class="addr-select-top">
										...
										<button type="button" class="addr-delete-btn"
											@click.stop="deleteAddress(addr.addressId)">삭제</button>
									</div>

									<!-- 이름 + 연락처 한 줄 -->
									<div class="addr-select-meta">
										<span>{{ addr.receiverName }}</span>
										<span class="addr-meta-divider">·</span>
				...
				<script>
					...
					const app = Vue.createApp({
						...
						computed: {
							...
							finalTotal() {
								return Math.max(0, this.itemTotal - this.couponDiscount - this.validUsePoint + this.shippingFee);
							},
							remainPoint() {
						...
						methods: {
							...
							checkIsIsland(addr) {
								...
								return patterns.some(p => normalized.includes(p.replace(/\s+/g, '')));
							},
