<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
	...
	<head>
		...
		<title>이용약관 · 개인정보처리방침 · 환불정책 — 캠핑박스</title>
		<style>
			* {
	...
	<body>
		...
		<div class="nav">
			<span class="nav-brand">⛺ 캠핑박스</span>
			<div class="nav-crumb">
				<span>홈</span> › <span class="cur">약관 및 정책</span>
			</div>
		</div>
		...
		<div class="layout">
			...
			<div class="side-nav">
				<div class="side-nav-inner">
					...
					<div class="side-tab" onclick="showDoc('privacy')">
			...
			<div class="content">
				...
				<div class="doc active" id="doc-terms">
					...
					<div class="doc-section">
						<h2>제1조 목적</h2>
						<p>이 약관은 캠핑박스(이하 "회사")가 운영하는 캠핑 장비 대여 서비스(이하 "서비스")의 이용 조건 및 절차, 회사와 회원 간의 권리·의무 및 책임사항을 규정함을
							목적으로 합니다.</p>
					</div>
					...
					<div class="doc-section">
						...
						<p>② 회사는 관련 법령에 위배되지 않는 범위에서 약관을 개정할 수 있으며, 개정 시 적용일자 및 개정 사유를 명시하여 현행 약관과 함께 서비스 초기 화면에 그 적용일자
							7일 이전부터 공지합니다.</p>
						<div class="notice-box orange">중요 사항이 변경되는 경우 최소 30일 전 사전 공지하며, 회원이 명시적으로 거부하지 않는 경우 변경에 동의한 것으로
							간주합니다.</div>
					</div>
					...
					<div class="doc-section">
						<h2>제7조 면책 조항</h2>
						<p>회사는 천재지변, 전쟁, 폭동, 파업 등 불가항력으로 인해 서비스를 제공할 수 없는 경우에는 책임이 면제됩니다. 또한 회원의 귀책 사유로 인한 서비스 장애에 대해서는
							책임을 지지 않습니다.</p>
						<div class="notice-box gray">서비스 이용 중 발생하는 회원 간 또는 회원과 제3자 간의 분쟁에 대해 회사는 개입 의무가 없으며, 이로 인한 손해를
							배상할 책임이 없습니다.</div>
					</div>
					...
					<div class="doc-actions">
						...
						<button class="btn-download">⬇ PDF 저장</button>
					</div>
				</div>
				...
				<div class="doc" id="doc-privacy">
					...
					<div class="doc-section">
						<div class="notice-box blue">캠핑박스는 개인정보보호법 등 관련 법령을 준수하며, 이용자의 개인정보를 소중히 보호합니다.</div>
					...
					<div class="doc-section">
						...
						<div class="notice-box blue">권리 행사는 마이페이지 → 개인정보 관리 또는 고객센터(privacy@campingbox.kr)로 요청할 수 있으며,
							10일 이내에 처리합니다.</div>
					</div>
				...
				<div class="doc" id="doc-refund">
					...
					<div class="doc-section">
						<div class="notice-box green">캠핑박스는 소비자기본법 및 전자상거래법에 따라 공정한 환불 정책을 운영합니다.</div>
						<h2>대여 취소 환불 기준</h2>
					...
					<div class="doc-section">
						...
						<div class="notice-box orange">파손·분실 배상은 반납일로부터 7일 이내에 등록된 결제 수단으로 자동 청구됩니다. 이의가 있는 경우 청구일로부터
					...
					<div class="doc-section">
						...
						<ol>
							...
							<li>이메일 접수: support@campingbox.kr</li>
						</ol>
