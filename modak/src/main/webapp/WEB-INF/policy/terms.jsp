					...
					<div class="content">
						...
						<div class="doc active" id="doc-terms">
							...
							<div class="doc-section">
								...
								<p>② 회사는 관련 법령에 위배되지 않는 범위에서 약관을 개정할 수 있으며, 개정 시 적용일자 및 개정 사유를 명시하여 현행 약관과 함께 서비스 초기 화면에
									그
									적용일자
									7일 이전부터 공지합니다.</p>
								<div class="notice-box orange">중요 사항이 변경되는 경우 최소 30일 전 사전 공지하며, 회원이 명시적으로 거부하지 않는 경우 변경에
									동의한
									것으로
									간주합니다.</div>
							</div>
							...
							<div class="doc-section">
								...
								<p>③ 장비 수령 시 상태를 확인하고 파손이 발견된 경우 즉시 고객센터에 신고하여야 합니다. 신고 없이 반납 시 해당 파손에 대한 책임은 회원에게 있습니다.
								</p>
							...
							<div class="doc-section">
								<h2>제7조 면책 조항</h2>
								<p>회사는 천재지변, 전쟁, 폭동, 파업 등 불가항력으로 인해 서비스를 제공할 수 없는 경우에는 책임이 면제됩니다. 또한 회원의 귀책 사유로 인한 서비스
									장애에
									대해서는
									책임을 지지 않습니다.</p>
								<div class="notice-box gray">서비스 이용 중 발생하는 회원 간 또는 회원과 제3자 간의 분쟁에 대해 회사는 개입 의무가 없으며, 이로
									인한
									손해를
									배상할 책임이 없습니다.</div>
							</div>
							...
							<div class="doc-section">
								...
								<p>본 약관은 대한민국 법률에 따라 규율되며, 서비스 이용과 관련하여 분쟁이 발생한 경우 회사 본사 소재지를 관할하는 법원을 전속 관할 법원으로 합니다.
								</p>
							</div>
						...
						<div class="doc" id="doc-refund">
							...
							<div class="doc-section">
								...
								<div class="notice-box green">영업시간(평일 09:00~18:00) 이후 접수된 취소 신청은 다음 영업일 기준으로 처리됩니다.
								</div>
							</div>
