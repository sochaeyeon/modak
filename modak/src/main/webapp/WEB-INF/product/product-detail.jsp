                        ...
                        <div class="gallery">
                            ...
                            <div class="gthumbs">
                                <div v-for="(img, idx) in productImages" :key="idx" class="gth"
                                    :class="{ on: mainImgUrl === img.imgUrl }" @click="setMainImg(img.imgUrl)">
                                    <img :src="img.imgUrl"
                        ...
                        <div class="pinfo">
                            ...
                            <div class="rrow">
                                ...
                                <span style="font-size:12px;color:var(--muted)">
                                    <a href="#" style="color:var(--orange);text-decoration:none">(리뷰 {{
                                        reviewList.length }}개)</a>
                                    | 구매·대여 {{ orderCount }}회
                                </span>
                            </div>
                            ...
                            <div class="buy-only">
                                ...
                                <div class="arow" style="margin-top:12px;">
                                    <button class="bwish" id="wb1" :class="{ on: isWished }" @click="fnWish($event)">{{
                                        isWished ? '❤️' : '🤍' }}</button>
                               ...
                               display:flex;align-items:center;justify-content:center;" @click.self="calOpen = false">
                                ...
                                <div class="arow" style="margin-top:12px;">
                                    <button class="bwish" id="wb2" :class="{ on: isWished }" @click="fnWish($event)">{{
                                        isWished ? '❤️' : '🤍' }}</button>
                                    <button class="bcart" @click="fnAddToCart">장바구니 담기</button>
                                    <button class="bbuy" :disabled="!startDate || !endDate"
                    ...
                    <div>
                        ...
                        <div class="tcont">
                                ...
                                <div class="rsum2">
                                    <div class="rbig">
                                        ...
                                        <div class="stars" style="justify-content:center;display:flex;margin:5px 0">
                                            <span v-for="(star, i) in avgStars" :key="i" class="st"
                                                :style="{ color: star === '★' ? '' : '#ddd' }">{{ star }}</span>
                                        </div>
                                            ...
                                            <div>
                                                ...
                                                <div class="stars" style="display:flex;gap:1px;margin-top:3px">
                                                    ...
                                                    <span style="font-size:12px;color:#999;margin-left:6px;">{{
                                                        Number(review.rating).toFixed(1) }}점</span>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="tpane" id="tp-qna">
                                <div v-if="faqList.length > 0" style="margin-bottom:20px;">
                                    <div v-for="f in faqList" :key="f.faqId" style="border-bottom:1px solid #eee;">
                                        <div @click="openFaqId = openFaqId === f.faqId ? null : f.faqId"
                                            ...
                                            <span style="color:var(--orange);font-size:20px;line-height:1;">{{ openFaqId
                                                === f.faqId ? '−' : '+' }}</span>
                                        </div>
                                ...
                                <div v-else style="text-align:center;padding:20px 0;color:var(--muted);font-size:14px;">
                                    등록된 FAQ가 없습니다.</div>
                                <div style="text-align:center;padding:20px 0 8px;">
                                    <p style="font-size:13px;color:var(--muted);margin-bottom:12px;">원하는 답변을 찾지
                                        못하셨나요?<br>평균 24시간 내 답변드립니다.</p>
                                    <button @click="fnInquiry"
                                        style="background:var(--orange);color:#fff;border:none;border-radius:8px;padding:10px 24px;font-size:14px;cursor:pointer;font-family:inherit;font-weight:500;">1:1
                                        문의하기</button>
                                </div>
                            </div>
                                ...
                                <div class="pcbody">
                                    ...
                                    <div class="pcacts">
                                        <button class="pca1"
                                            ...
                                            @click.stop="goDetail(item.productId, 'rent')">대여</button>
                                        <button class="pca2"
                                            v-if="item.productType === 'PURCHASE' || item.productType === 'BOTH'"
                                            @click.stop="goDetail(item.productId, 'buy')">구매</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div v-if="confirmModal.open" class="confirm-overlay" @click.self="confirmCancel">
                        <div class="confirm-box">
                            ...
                            <div class="confirm-btns">
                                <button class="confirm-cancel" @click="confirmCancel">{{ confirmModal.cancelText
                                    }}</button>
