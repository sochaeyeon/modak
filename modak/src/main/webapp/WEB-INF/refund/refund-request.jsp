        ...
        <%@ include file="/WEB-INF/common/header.jsp" %>
            ...
            <div id="app" v-cloak>
                <div class="exchange-page">
                    ...
                    <!-- 헤더 -->
                    <p class="page-eyebrow">REFUND REQUEST</p>
                    <h1 class="page-title">환불 신청</h1>
                    <p class="page-desc">구매하신 상품을 환불하실 수 있어요. 아래 정보를 입력해 주세요.</p>
                                ...
                                <div class="section-body">
                                    ...
                                    <div v-if="selectedReason === 'OTHER' || selectedReason">
                                        ...
                                        <textarea class="reason-textarea" v-model="reasonDetail"
                                            :placeholder="selectedReason === 'OTHER' ? '환불 사유를 직접 입력해 주세요.' : '추가로 전달할 내용이 있으면 입력해 주세요.'"
                                ...
                                $.ajax({
                                    ...
                                    success: function (res) {
                                        ...
                                        if (res.result === 'success') {
                                            ...
                                            self.fnShowToast(res.message || '환불 신청 실패');
                                        }
                                    },
                                    error: function () {
                                        self.isSubmitting = false;
