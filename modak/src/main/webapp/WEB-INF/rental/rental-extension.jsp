                                ...
                                <div v-if="['RESERVED','IN_USE'].includes(selectedRental.rentalStatus)">
                                    <div class="ext-form-row">
                                        ...
                                        <div class="price-preview">
                                            ...
                                            <span class="price-preview-val">{{ fnPrice(extensionDays *
                                                (selectedRental.pricePerDay || 5000)) }}</span>
                                        </div>
                        ...
                        var app = Vue.createApp({
                            ...
                            methods: {
                                ...
                                fnApply: function () {
                                    ...
                                    self.fnOpenModal({
                                        title: '대여를 연장하시겠습니까?',
                                        message: '<strong>' + self.extensionDays + '일</strong> 연장됩니다.<br>예상 금액은 <strong>' + expectedPrice + '</strong>입니다.', confirmText: '연장 신청',
                                        onConfirm: function () {
