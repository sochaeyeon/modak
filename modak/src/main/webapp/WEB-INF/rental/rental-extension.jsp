        ...
        <div>
            ...
            <div class="ext-panel" v-if="selectedRental">
                ...
                <div class="ext-panel-head">
                    ...
                    <button type="button" class="btn-close-panel" v-if="!isGuest" @click="fnClosePanel">✕</button>
                            ...
                            <div class="ext-form-row">
                                <div class="form-group">
                                    ...
                                    <div class="days-stepper">
                                        ...
                                        <input type="number" class="stepper-input" v-model.number="extensionDays"
                                            min="1" max="30"
                        ...
                        <div class="return-info-box">
                            <div class="form-group" style="margin-bottom:10px;">
                                ...
                                <div style="display:flex;gap:8px;">
                                    ...
                                    <button type="button" class="btn-back" @click="fnSearchPickupAddress">주소 검색</button>
                                </div>
                            </div>
                            <div class="form-group" style="margin-bottom:10px;">
                                <label class="form-label">회수 주소</label>
                                <input type="text" class="form-input" v-model="pickup.address" style="width:100%;" readonly>
                            </div>
                            ...
                            <div v-for="(ret, idx) in returnHistory" :key="idx" class="ext-item">
                                ...
                                <div class="ext-item-body">
                                    ...
                                    <p class="ext-item-date" v-if="ret.address">
                                        회수지: {{ ret.address }}<span v-if="ret.detailedAddress"> {{ ret.detailedAddress }}</span>
                                    </p>
                                </div>
        ...
        fnApply: function () {
            ...
            self.fnOpenModal({
                ...
                onConfirm: function () {
                    ...
                    var data = { rentalId: self.selectedRental.rentalId, extensionDays: self.extensionDays };
                    if (self.isGuest) data.token = self.guestToken;
                    $.ajax({
                        url: '/rental/extension/apply.dox', type: 'POST', dataType: 'json', data: data,
                        success: function (res) {
                            ...
                            } else { self.showToast(res.message || '연장 신청에 실패했습니다.'); }
                        },
