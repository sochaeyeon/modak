            ...
            <div class="ext-panel" v-if="selectedRental">
                <div class="ext-panel-head">
                    ...
                    <div class="ext-panel-img">
                        <img v-if="selectedRental.imgUrl"
                            :src="selectedRental.imgUrl"
    ...
    var app = Vue.createApp({
        ...
        methods: {
            ...
            fnStatusText: function (s) {
                var map = {
                    PAID: '결제완료', READY: '상품준비중', SHIPPING: '배송중',
                    DONE: '배송완료', RESERVED: '예약완료', RENTING: '대여중',
                    IN_USE: '대여중', RETURNED: '반납완료',
                    RETURN_COMPLETED: '반납완료', CANCELLED: '취소'
                };
                return map[s] || s || '-';
            },
