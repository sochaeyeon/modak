                                    ...
                                    <div v-for="rental in rentalList" :key="rental.rentalId" class="rental-card"
                                        ...
                                        <div class="rental-icon">
                                            ...
                                            <span :style="rental.imgUrl ? 'display:none' : 'display:flex'"
                                                style="width:100%;height:100%;align-items:center;justify-content:center;font-size:22px;">
                                                ⛺
                                            </span>
                                        </div>
                                        ...
                                        <div class="rental-card-actions">
                                            <button type="button" class="mini-action-btn"
                                                ...
                                                @click.stop="fnOpenExtension(rental)">
                                                연장 신청
                                            </button>

                                            <button type="button" class="mini-action-btn return"
                                                v-if="['RESERVED','IN_USE'].includes(rental.rentalStatus)"
                                                @click.stop="fnOpenReturn(rental)">
                                                반납 신청
                                            </button>
                                ...
                                <div class="ext-history">
                                    ...
                                    <div class="ext-items" v-else>
                                        <div v-for="ext in extensions" :key="ext.extensionId" class="ext-item">
                                            ...
                                            <button class="btn-ext-cancel" @click="fnCancelExtension(ext.extensionId)">
                                                취소
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div class="return-info-box">
                                        <div class="form-group" style="margin-bottom:10px;">
                                            ...
                                            <div style="display:flex; gap:8px;">
                                                ...
                                                <button type="button" class="btn-back" @click="fnSearchPickupAddress">
                                                    주소 검색
                                                </button>
                                            </div>
                                        </div>
                ...
                <script>
                    var app = Vue.createApp({
                        ...
                        methods: {
                            ...
                            fnOpenExtension: function (rental) {
                                this.activeTab = 'extension';
                                this.fnSelectRental(rental);
                            },

                            fnOpenReturn: function (rental) {
                                ...
                                new daum.Postcode({
                                    oncomplete: function (data) {
                                        ...
                                        self.$nextTick(function () {
                                            if (self.$refs.pickupDetailAddressInput) {
                                                self.$refs.pickupDetailAddressInput.focus();
                                            }
                                        });
                                    }
                                }).open();
                            ...
                            fnLoadAddress: function () {
                                ...
                                $.ajax({
                                    url: '/rental/extension/return/address.dox',
                                    type: 'POST',
                                    dataType: 'json',
                            ...
                            fnLoadGuestAddress: function () {
                                ...
                                $.ajax({
                                    url: '/rental/extension/return/guest/address.dox',
                                    type: 'POST',
                                    dataType: 'json',
                                    data: {
                                        rentalId: self.guestRentalId
                                    },
                                    success: function (res) {
                                        if (res.result === 'success' && res.address) {
                                            self.pickup.zipcode = res.address.zipcode || '';
                            ...
                            fnApply: function () {
                                ...
                                self.fnOpenModal({
                                    title: '대여를 연장하시겠습니까?',
                                    message: '<strong>' + self.extensionDays + '일</strong> 연장됩니다.<br>예상 금액은 <strong>' + expectedPrice + '</strong>입니다.',
                                    confirmText: '연장 신청',
                                    onConfirm: function () {
                                        ...
                                        $.ajax({
                                            ...
                                            success: function (res) {
                                                ...
                                                if (res.result === 'success') {
                                                    self.showToast(res.message || '연장 신청이 완료되었습니다.');
                            ...
                            fnApplyReturn: function (rental) {
                                ...
                                if (!['RESERVED', 'IN_USE'].includes(rental.rentalStatus)) {
                                    self.showToast('예약완료 또는 대여중 상태만 반납 신청 가능합니다.');
                                    return;
                                }

                                if (!self.pickup.address || !self.pickup.detailedAddress) {
                                    self.showToast('회수 주소를 입력해주세요.');
                                    return;
                                }
                                            ...
                                            success: function (res) {
                                                ...
                                                if (res.result === 'success') {
                                                    ...
                                                    if (self.isGuest) {
                                                        ...
                                                        self.fnLoadMemberList();
                                                        self.selectedRental = null;
                                                    }
                                                } else {
                                                    self.showToast(res.message || '반납 신청에 실패했습니다.');
                                                }
                                            },
                                            error: function () {
                                                self.isApplying = false;
                            ...
                            fnRemainText: function (value) {
                                ...
                                var target = new Date(String(value).replace(' ', 'T'));
