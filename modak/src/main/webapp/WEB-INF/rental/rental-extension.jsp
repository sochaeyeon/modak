...
<head>
    ...
    <style>
        ...
        .rental-ext-history {
            ...
            margin-top: 12px;
            padding-top: 12px;
            border-top: 1px dashed rgba(92, 66, 48, 0.18);
        }
        .ext-hist-title {
            font-size: 12px;
            font-weight: 800;
        ...
        .ext-hist-days  { font-weight: 900; color: #C4621E; min-width: 44px; }
        .ext-hist-price { font-weight: 800; color: #2C1E0F; min-width: 72px; }
        .ext-hist-date  { color: #8B6B4A; flex: 1; }
        .btn-ext-cancel-small {
        ...
        .btn-ext-cancel-small:hover { background: #ffe0e0; }
    </style>
</head>
                ...
                <div class="section-card" v-if="!isGuest || guestOrderId || guestRentalId">
                    ...
                    <div class="section-body">
                        ...
                        <div class="rental-list" v-else>
                            ...
                            <div v-for="rental in rentalList"
                                 :key="rental.rentalId"
                                 class="rental-card"
                                    ...
                                    <div class="form-group" style="margin-bottom:10px;">
                                        ...
                                        <div style="display:flex;gap:8px;">
                                            ...
                                            <button type="button" class="btn-back"
                                                    @click="fnSearchPickupAddress">주소 검색</button>
                                        </div>
                                    </div>
                                    <div class="form-group" style="margin-bottom:10px;">
        ...
        <div v-if="modal.show" class="delete-modal-backdrop" @click.self="fnCloseModal">
            <div class="delete-modal-box">
                ...
                <div class="delete-modal-actions">
                    <button type="button" class="delete-confirm-btn" @click="fnModalConfirm">{{ modal.confirmText }}</button>
    ...
    createApp({
        ...
        methods: {
            ...
            fnInit: function () {
                ...
                if (orderId && token) {
                    ...
                    var check = setInterval(function () {
                        ...
                        if (found) { clearInterval(check); self.fnSelectRental(found); }
                    }, 200);
            ...
            fnLoadAddress: function () {
                var self = this;
                $.ajax({ url: '/rental/extension/return/address.dox', type: 'POST', dataType: 'json',
            ...
            fnLoadGuestAddress: function () {
                var self = this;
                $.ajax({ url: '/rental/extension/return/guest/address.dox', type: 'POST', dataType: 'json',
            ...
            fnLoadMemberList: function () {
                var self = this;
                self.isLoading = true;
                $.ajax({ url: '/rental/extension/list.dox', type: 'POST', dataType: 'json',
                    success: function (res) {
            ...
            fnLoadGuestOrderRentals: function () {
                var self = this;
                self.isLoading = true;
                $.ajax({ url: '/rental/extension/guest/order-list.dox', type: 'POST', dataType: 'json',
            ...
            fnLoadGuestDetail: function () {
                var self = this;
                self.isLoading = true;
                $.ajax({ url: '/rental/extension/guest/detail.dox', type: 'POST', dataType: 'json',
            ...
            fnSelectRental: function (rental) {
                ...
                $.ajax({ url: '/rental/extension/detail.dox', type: 'POST', dataType: 'json',
