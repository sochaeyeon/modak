	...
	<%@ taglib prefix="c" uri="jakarta.tags.core" %>
				...
				<%@ include file="/WEB-INF/common/header.jsp" %>
					<div id="app" v-cloak>
						...
						<main>
							...
							<p class="page-subtitle"><i class="ri-fire-line"></i> 솔직한 후기가 다른 캠버들에게 큰 도움이 됩니다</p>
							...
							<div class="card product-card" :class="{ 'is-open': isOrderDetailOpen }"
								...
								<span class="badge-shipped" v-if="selectedItem && selectedItem.reviewStatusText">
									{{ selectedItem.reviewStatusText }}
								</span>
							</div>
        ...
        selectedItem && selectedItem.itemId == item.itemId ? 'is-active' : ''
						...
						<div v-if="modal.show" class="modal-backdrop" @click.self="fnCloseModal">
							<div class="modal-box">
								<div class="modal-title">작성을 취소하시겠어요?</div>
								<div class="modal-desc">작성 중인 내용이 저장되지 않습니다.</div>
								<div class="modal-actions">
									<button class="modal-confirm-btn" @click="fnModalConfirm">취소하기</button>
									<button class="modal-cancel-btn" @click="fnCloseModal">계속 작성</button>
								</div>
							</div>
						</div>
					</div>
