                        ...
                        <div class="panel-content active" id="panel-id">
                            ...
                            <div class="method-tabs" v-if="!isIdFound">
                                <button class="method-btn active" onclick="switchIdMethod('email', this)">이름 +
                                    이메일</button>
                                <button class="method-btn" onclick="switchIdMethod('phone', this)">이름 + 전화번호</button>
                            </div>
                            ...
                            <div id="id-email-form" v-if="!isIdFound">
                                <div class="form-group">
                                    ...
                                    <input v-model="userName" @input="fnClearNameError" type="text" class="form-input"
                                        :class="{ 'input-error': nameErrMsg }" placeholder="실명을 입력해 주세요"
                                        id="id-name-email" />
                            ...
                            <div id="id-phone-form" class="hidden" v-if="!isIdFound">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-row">
                                        <input v-model="userPhone" @input="fnOnlyNumber" type="text" class="form-input"
                                            :class="{ 'input-error': phoneErrMsg }" placeholder="01012345678"
                                            maxlength="11" id="id-phone" />
                                ...
                                <div class="form-group" v-if="smsSent">
                                    ...
                                    <div class="input-row">
                                        <input v-model="authCode" type="text" class="form-input" placeholder="6자리 숫자 입력"
                                            maxlength="6" />
                        ...
                        <div class="panel-content" id="panel-pw">
                            ...
                            <div id="pw-step1">
                                ...
                                <div class="form-group">
                                    ...
                                    <input v-model="pwId" type="text" class="form-input" placeholder="사용 중인 아이디" :disabled="pwVerified" />
                                </div>
                                <div class="form-group">
                                    <label class="form-label">이메일</label>
                                    <div class="input-row">
                                        <input v-model="pwEmail" type="email" class="form-input"
                                            placeholder="가입한 이메일 주소" :disabled="pwVerified"  />
                            ...
                            <div id="pw-step2" class="hidden">
                                ...
                                <div
                                    ...
                                    <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
                                        <circle cx="18" cy="18" r="17" fill="#e8622a" opacity="0.12" stroke="#e8622a"
                                            stroke-width="1.5" />
                                        <path d="M11 19l5 5 9-10" stroke="#e8622a" stroke-width="2.2"
                                            stroke-linecap="round" stroke-linejoin="round" />
                                    </svg>
                                    <div>
                                        <div style="font-size:13px;font-weight:700;color:var(--brown);">인증이 완료되었어요</div>
                                        <div style="font-size:11.5px;color:var(--text-sub);margin-top:2px;">modak_***r
                                            님, 새 비밀번호를 설정해 주세요.</div>
                                    </div>
                                </div>
                            ...
                            <div id="pw-step3" class="hidden">
                                <div class="section-title">새 비밀번호 설정</div>
                                <div class="section-desc">영문, 숫자, 특수문자를 포함해 8자 이상 입력해 주세요.</div>
                                <div class="form-group">
                                    <label class="form-label">새 비밀번호</label>
                                    <input type="password" class="form-input" placeholder="8자 이상, 영문+숫자+특수문자"
                                        id="pw-new" oninput="checkPwStrength(this.value)" />
                                    <!-- strength bar -->
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" class="form-input" placeholder="비밀번호를 한 번 더 입력해 주세요"
                                        id="pw-confirm" oninput="checkPwMatch()" />
                                    <div id="pw-match-msg" style="font-size:11px;margin-top:4px;"></div>
                                </div>
                                <button class="btn-submit" type="button" @click="fnResetPassword">비밀번호 변경 완료</button>
                            </div>
        ...
        const app = Vue.createApp({
            ...
            methods: {
                ...
                fnSendPwVerifyEmail: function () {
                    ...
                    // 🔥 나중에 실제 인증메일 발송 AJAX 붙일 자리
                    self.pwVerified = true;
                    self.pwVerifyMsg = '이메일 인증이 완료되었습니다.';
                },
                    ...
                    $.ajax({
                        ...
                        success: function (data) {
                            if (data.result === "success") {
                                ...
                                // 기존 타이머 UI 그대로 쓰려면
                                const grp = document.getElementById('pw-code-group');
